...
const OfficeSpacesScreen: React.FC = () => {
    ...
    const [securityOption, setSecurityOption] = useState("Select NOTERY/Agreement");
    ...
    return (
        ...
        >
            ...
            <View style={styles.inputBox}>
                ...
                <TouchableOpacity style={styles.dropdownStatic}>
            ...
            {/* Preferred Tenants (multiple selection) */}
            <View style={styles.iconRow}>
                <Octicons name="person" size={15} style={{ marginRight: wp(2) }} color="#555" />
                <Text style={styles.subTitle}>Preferred Tenants*</Text>
            </View>
            <View style={styles.rowWrap}>
                {["Family", "Men Bachelors", "Bachelors", "Women Bachelors", "Company"].map(
                    (item) => (
                        <TouchableOpacity
                            key={item}
                            style={[
            ...
            <View style={styles.inputBoxBottom}>
                <TouchableOpacity
                    ...
                    activeOpacity={0.8}
                >
                    <Text style={[styles.placeholderText, { color: "#00000099", fontFamily: 'Poppins-Medium' }]}>
                        {securityOption}
                    </Text>
                    <MaterialIcons
...
export default OfficeSpacesScreen;
