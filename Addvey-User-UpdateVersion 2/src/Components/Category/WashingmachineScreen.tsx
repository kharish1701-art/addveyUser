...
const WashingmachineScreen: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {/* Box */}
            <View style={styles.iconRow}>
                <Feather name="box" size={14} style={{ marginRight: wp(2) }} color="#444" />
            ...
            <View style={styles.inputBox}>
                ...
                <View style={styles.inputRow}>
                    <TextInput
                        style={styles.input}
                        value={warrantyValid}
                        onChangeText={setWarrantyValid}
                        placeholder="30/09/2026"
                    // keyboardType="numeric" // date-like value, keep default keyboard
                    />
