...
const Distance: React.FC<ListTypeModalProps> = ({ onClose, onSelect, selectedValue }) => {
    // Default logic might need check
    const [selectedOption, setSelectedOption] = useState<string>(selectedValue || "Sell");
